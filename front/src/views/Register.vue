  ...
  <div class="container login-container ">
    <div class="row">
      <div class="col-md-3 login-form-2">
        ...
        <p class="" style="color:#191919">If you already have an account, you can login here</p>
      ...
      <div div class="col-md-6 login-form-1">
        <form name="form" @submit.prevent="handleRegister">
          <div v-if="!successful">
            ...
            <div class="form-group">
              <button class="btn btn-block" style="background-color: #2f7aae; color: #191919 ">Sign Up</button>
            </div>
          </div>
        </form>
